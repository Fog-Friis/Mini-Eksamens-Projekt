...
if (maxID2 == maxID){
 ...
 try{
  ...
  try {
     String QUERY14 = "UPDATE klasse SET elevAntal = "+klasseAntal+"  WHERE klasseID = "+regVerifikationElevTB.Text+";";
  ...
  try {
     ...
     String QUERY15 = ("INSERT INTO klasse (elevID"+klasseAntal+") VALUES ( "+maxID2+");");
